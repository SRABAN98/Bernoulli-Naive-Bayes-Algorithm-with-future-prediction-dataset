...
y_pred_BernoulliNB = pd.DataFrame()

d2["y_pred_BernoulliNB"] = classifier.predict(M)


#save the future prediction dataframe as the .csv file format
d2.to_csv("FPofBernoulliNBAlgo.csv")
